                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="{{ route('siswa.binasekolah',$permasalahan->id) }}">Pembinaan yang diberikan</a></li>
                                <li><a class="dropdown-item" href="#"><form action="{{ route('permasalahansekolah.destroy',$permasalahan->id) }}" method="post">
                                  {{ csrf_field() }}
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="{{ url('siswa/'.$permasalahan->id.'/edit-permasalahan') }}"  method="POST">
                                  {{ csrf_field() }}
                        ...
                        <div class="modal fade" id="{{ 'modal'.$permasalahan->id }}_view" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="{{ url('siswa/'.$siswa->id.'/create-pembinaan-sekolah') }}"  method="POST">
                                  {{ csrf_field() }}
                                  <div class="form-floating mb-3">
                                    <input type="hidden" value="{{ $siswa->id_user }}" name="id_user" class="form-control" id="floatingInput" >
                                  </div>
                        ...
                        <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="{{ url('siswa/'.$siswa->id.'/create-permasalahan-disekolah') }}"  method="POST">
                                  {{ csrf_field() }}
                                  <div class="form-floating mb-3">
                                    <input type="hidden" value="{{ $siswa->id_user }}" name="id_user" class="form-control" id="floatingInput" >
                                  </div>
                  ...
                  <div class="accordion-body">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#{{ 'modal'.$catatan->id }}_detail">Detail Catatan</a></li>
                                <li><form action="{{ route('catatansekolah.destroy',$catatan->id,) }}" method="post">
                                  {{ csrf_field() }}
                                  <input type="hidden" name="_method" value="DELETE">
                                  <button type="submit"  style="margin-left: 1px;border:none;color:red"
                        ...
                        <div class="modal fade" id="{{ 'modal'.$catatan->id }}_detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                        ...
                        <div class="modal fade" id="{{ 'modal'.$catatan->id }}_edit_catatan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="{{ url('siswa/'.$catatan->id.'/edit-catatan-sekolah') }}"  method="POST">
                                  {{ csrf_field() }}
                                  <div class="form-floating mb-3">
                                    <input type="hidden" value="{{ $siswa->id_user }}" name="id_user" class="form-control" id="floatingInput" >
                                  </div>
                        ...
                        <div class="modal fade" id="catatan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="{{ url('siswa/'.$siswa->id.'/catatan-sekolah') }}"  method="POST">
                                  {{ csrf_field() }}
                                  <div class="form-floating mb-3">
                                    <input type="hidden" value="{{ $siswa->id_user }}" name="id_user" class="form-control" id="floatingInput" >
                                  </div>
