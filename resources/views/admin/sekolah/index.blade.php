              ...
              <div class="modal fade" id="{{ 'modal'.$siswa->id }}_profile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group" style="float: right"> 
                      <li><a class="dropdown-item" style="border: 1px solid" href="{{ route('siswa.sekolah',$siswa->id) }}">view  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
