...
-->
    ...
    <link rel="stylesheet" type="text/css" href="css2/fullpage.min.css">
    ...
    <div id="video">
        ...
        <video autoplay muted loop id="myVideo">
          <source src="images2/video-bg.mp4" type="video/mp4">
        </video>
                                        ...
                                        <div class="item animate" data-animate="fadeInUp">
                                            <div class="testimonial-item">
                                                <div class="client-row">
                                                    <img src="{{ asset('3/IMG-20220408-WA0009.jpg') }}" style="width:200px;height:200px" class="rounded-circle" alt="profile 1">
                                                </div>
            ...
            <div class="section animated-row" data-section="slide01">
                <div class="section-inner">
                    <div class="welcome-box">
                        ...
                        <div class="scroll-down next-section animate data-animate="fadeInUp""><img src="images2/mouse-scroll.png" alt=""><span>Scroll Down</span></div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="about-contentbox">
                                            <div class="animate" data-animate="fadeInUp">
                                                <figure class="about-img animate" data-animate="fadeInUp"><img src="{{ asset('3/IMG-20220408-WA0009.jpg') }}" class="rounded" alt=""></figure>
                                                <div class="col-md-6"><h2>irfan</h2>
                                                </div>
                                            </div>
                                ...
                                <div class="gallery-list owl-carousel">
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="portfolio-item">
                                            <div class="thumb">
                                                <img src="images2/item-1.jpg" alt="">
                                            </div>
                                    ...
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="portfolio-item">
                                            <div class="thumb">
                                                <img src="images2/item-2.jpg" alt="">
                                            </div>
                                            <div class="thumb-inner animate" data-animate="fadeInUp">
                                                <h4>templatemo is the best</h4>
                                    ...
                                    <div class="item animate" data-animate="fadeInUp">
                                        <div class="portfolio-item">
                                            <div class="thumb">
                                                <img src="images2/item-3.jpg" alt="">
                                            </div>
                                            <div class="thumb-inner animate" data-animate="fadeInUp">
                                                <h4>templatemo is the best</h4>
    ...
    <script src="js2/fullpage.min.js"></script>

    <script src="js2/scrolloverflow.js"></script>
